...
$(document).ready(function(){
	...
	//Saves color of navigation element from page load state first.
	var original_element_text_color = null
	var original_element_background_color = null
	$('.navigation_element').mouseenter(function(){
		original_element_text_color = $(this).css("color");
		original_element_background_color = $(this).css("background-color");	
		$(this).animate({color: "white" , backgroundColor: "#d2b48c"},800);
	});

	$('.navigation_element').mouseleave(function(){
		$(this).animate({color: original_element_text_color , backgroundColor: original_element_background_color},400);
	});
